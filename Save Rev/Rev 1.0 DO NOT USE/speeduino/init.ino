...
void setPinMapping(byte boardID)
{
  ...
  if ( (configPage13.APthrottleBodyEnable != 0) && (configPage13.TBPositionPin1 < BOARD_MAX_IO_PINS) ) { pinTBSensor = pinTranslateAnalog(configPage13.TBPositionPin1); }// Amesis Project
  if ( (configPage13.APthrottleBodyEnable != 0) && (configPage13.TBMotorPin1 < BOARD_MAX_IO_PINS) ) { pinTBMotor1 = pinTranslate(configPage13.TBMotorPin1); }// Amesis Project
  if ( (configPage13.APthrottleBodyEnable != 0) && (configPage13.TBMotorPin2 < BOARD_MAX_IO_PINS) ) { pinTBMotor2 = pinTranslate(configPage13.TBMotorPin2); }// Amesis Project
  if ( (configPage13.APthrottleBodyEnable != 0) && (configPage13.TBMotorPinENA <  BOARD_MAX_IO_PINS) ) { pinTBMotorENA = pinTranslateAnalog(configPage13.TBMotorPinENA); }// Amesis Project
...
// #endif
  ...
  if(configPage13.APthrottleBodyEnable > 0)
  {
    ...
    pinMode(pinTBSensor,INPUT);
    pinMode(pinTBMotor1,OUTPUT);
    pinMode(pinTBMotor2,OUTPUT);
    pinMode(pinTBMotorENA,OUTPUT);
  } 
