...
//Pedal Acelerador
const int pin_ACL01 = A2;           // Pino de entrada analógica do potenciômetro pino 6
...
//Corpo de Borboleta
const int pin_TPS01 = A15;           // Pino de entrada analógica do potenciômetro tps pino 4
...
//Ponte H L298N// (O módulo L298N é um módulo de energia para alimentar o motor DC porque o arduino não fornece energia para meus controles)
      ...
      int pin_IN01 = 49;             // Portas de controle do motor A no sentido horário
      int pin_IN02 = 51;             // Portas de controle do motor B no sentido anti-horário
...
//Valores Acelerador
const int ACL_MIN = 140;
const int ACL_MAX = 980;
